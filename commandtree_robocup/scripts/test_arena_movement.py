...
if __name__ == "__main__":
    ...
    tasks = [generate_example_task(atwork_commander_msgs.msg.Object.S40_40_B)] # task with one object
    tasks.append(generate_example_task(atwork_commander_msgs.msg.Object.MOTOR))

    #for t in task:
    #task[0][2] = task[0][2].object
    #task[1][2] = task[1][2].object
    rospy.loginfo('Drive to all workstations: ')
